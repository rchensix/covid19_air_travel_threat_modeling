...
def implementation(num_days: int, mode: Union[str, None]=None, num_procs: Union[int, None]=None,
                   seed: int=0, log_path: Union[str, None]=None, 
                   sim_param_file: Union[str, None]=None):
    t_incubation = 2
    t_infectious = 28
    init_conditions = {
...
def main():
    ...
    parser.add_argument('--sim_param_file', type=str, help='path to sim param file')
    args = parser.parse_args()
    implementation(args.num_days, args.mode, args.num_procs, args.seed, args.log_path,
                   args.sim_param_file)
